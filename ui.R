  ...
  mainPanel(
    ...
    uiOutput("logo"),
            ...
            radioButtons("q2", "What is the heaviest recorded Mola mola?", 
                         list("506 kg" = 0.001, "4100 kg" = 0, "2300 kg" = 1, "125 kg" = 0),
                         selected = 0.001),
            radioButtons("q3", "What avoidable hazard to humans pose to Mola mola?",
                         list("Sneezing" = 0.001, "Swimming in the ocean" = 0, "Keeping them as house pets" = 0, "Polluting the ocean with plastic bags that make them suffocate and starve" = 1),
                         selected = 0.001),
            ...
            radioButtons("q5", "What is the English translation of the Chinese name for Mola mola?", 
                         list("Large grey fish" = 0.001, "Toppled car fish" = 1, "Sunfish" = 0, "Jellyfish eater" = 0),
                         selected = 0.001),
